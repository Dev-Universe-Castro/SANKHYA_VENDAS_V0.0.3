...
export default function PartnersTable() {
  ...
  // Carregar parceiros quando página ou busca mudar
  useEffect(() => {
    loadPartners()
  ...
  const loadPartners = async () => {
    try {
      setIsLoading(true)
      const url = `/api/sankhya/parceiros?page=${currentPage}&pageSize=${ITEMS_PER_PAGE}&search=${encodeURIComponent(debouncedSearchTerm)}`
